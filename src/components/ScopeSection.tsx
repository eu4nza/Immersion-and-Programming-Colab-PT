...
export default function ScopeSection() {
  return (
    <section
      id="scope"
      className="w-full 2xl:px-24 px-4 2xl:py-20 py-14 h-auto dark:bg-[#191a1f] dark:bg-[url('/images/scope/scope_background_black.svg')] bg-[url('/images/scope/scope_background_white.svg')] bg-top bg-repeat bg-[length:500px_500px]"
    >
